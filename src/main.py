...
file_path = os.path.join(
    os.path.dirname(__file__), "../data/fire_data.geojson"
)
...
def batch_insert_dynamodb(
    table_name: str, features: List[Dict[str, Any]]
) -> None:
    ...
    with table.batch_writer() as batch:
        for feature in features:
            ...
            batch.put_item(Item=convert_types(item))
